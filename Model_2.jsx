...
Command: npx gltfjsx@6.5.3 ./public/model_2.glb 
*/
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <mesh name="hand_2_box" geometry={nodes.hand_2_box.geometry} material={nodes.hand_2_box.material} position={[8.927, 9.157, 0.257]} rotation={[0, 0, Math.PI / 2]}>
          <mesh name="hand_2" geometry={nodes.hand_2.geometry} material={nodes.hand_2.material} position={[0.25, 2.3, -0.2]} rotation={[Math.PI, 0, 0]} />
        </mesh>
