...
function CursorElem(props)
{
    ...
    if(_appContext.Level.current == 1){succesZoneSize = successZoneSizeArr[0];succesZonePosition = SuccessZonePositionArr[0]}
    ...
    let checkCursorPosition = ()=>
        ...
        // if(_appContext.Level.current == 2){cursorController('INCREASE-SPEED'); }
        // else if(_appContext.Level.current == 3){cursorController('INCREASE-SPEED');}
        // else if(_appContext.Level.current == 4){cursorController('INCREASE-SPEED');}
    useEffect(()=>
        {
            startCursorMove();
