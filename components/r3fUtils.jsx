...
export function generateBlockData(level)
    {
        ...
        const Block_2 = [nodes.block_2.geometry,'block_2',[{blockGeo:nodes.block_2_left.geometry,blockName:'block_2_left',blockAnime:'block_2_leftAction',blockPos:[0, 2, 0],blockRot:[0,0,0],blockScale:1},
                                                 {blockGeo:nodes.block_2_right.geometry,blockName:'block_2_right',blockAnime:'block_2_rightAction',blockPos:[0, 2, 0],blockRot:[0,0,0],blockScale:1}],null,'none',1]
        ...
        const Block_3 = [nodes.block_3.geometry,'block_3',[{blockGeo:nodes.block_3_left.geometry,blockName:'block_3_left',blockAnime:'block_3_leftAction',blockPos:[0, 2, 0],blockRot:[0,0,0],blockScale:1},
                                                 {blockGeo:nodes.block_3_right.geometry,blockName:'block_3_right',blockAnime:'block_3_rightAction',blockPos:[0, 2, 0],blockRot:[0,0,0],blockScale:1}],null,'none',1]
        ...
        const Block_4 = [nodes.block_4.geometry,'block_4',[{blockGeo:nodes.block_4_left.geometry,blockName:'block_4_left',blockAnime:'block_4_leftAction',blockPos:[0, 2, 0],blockRot:[0,0,0],blockScale:1},
                                                 {blockGeo:nodes.block_4_right.geometry,blockName:'block_4_right',blockAnime:'block_4_rightAction',blockPos:[0, 2, 0],blockRot:[0,0,0],blockScale:1}],null,'none',1]
       ...
       ],[{blockGeo:nodes.block_7_explosion.geometry,blockName:'block_7_explosion',blockAnime:null,blockPos:[0.009, 2.825, 0.083],blockRot:[0, 0, -Math.PI / 2],blockScale:1},

        ],1,1]

        if(level == 1){return Block_1}
        else if(level == 2){return Block_2}
        else if(level == 3){return Block_3}
        else if(level == 4){return Block_5}
        else if(level >= 5){return Block_7}
        // if(level >= 1 && level < 3)
        // {
        //     return Block_1
        // }
